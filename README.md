...
|---|---|---|
| `sample_interval` | `3s` | intervallo tra due letture; minimo 1 s (vedi sotto) |
| `window_size` | `10` | campioni per mediana; si pubblica ogni `sample_interval × window_size` |
...
- **`sample_interval` di almeno 1 s**: a 12 bit una lettura della DS18B20 richiede 750 ms. Con un intervallo più corto ESPHome annulla ogni lettura prima che finisca e il sensore non pubblica nulla.
